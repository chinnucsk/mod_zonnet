...
{% block widget_headline %}
    {{ headline }}
    {% if media %}
        {% button class="btn btn-mini pull-right" action={redirect dispatch="plainzonnet"} text=_"show all"%}
    {% else %}
        {% button class="btn btn-mini pull-right" action={redirect dispatch=cat} text=_"show all"%}
    {% endif %}
{% endblock %}
